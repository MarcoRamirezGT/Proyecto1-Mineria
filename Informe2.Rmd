...
En cada uno de los modelos realizados se utilizo laplace, en este caso se crearon 3 modelos con la misma variable respuesta pero cada una con diferente transformada de laplace y 2 modelos con otro tipo de variable respuesta para poder ir realizando distintas pruebas.

Las variables respuesta que utilizamos en estos modelos fueron "Clase de Union" y "Escolaridad de hombre y mujer" ya que al relacionar estas dos variables podemos obtener una prediccion bastante buena para las variables respuesta.
