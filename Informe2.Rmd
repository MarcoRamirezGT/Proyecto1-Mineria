...
```
De los diferentes modelos que realizamos el que realizo la mejor prediccion fue el segundo modelo ya que nos dio un 80% de precision, y esto fue porque existen muchos valores de prediccion que se calcularon con laplace en relacion al valor esperado y estos eran iguales. Entre mas valores iguales existan, la prediccion sera mejor.
